...
const SignIn = () => {
  ...
  return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{backgroundImage:`url(${bg})`}}>
        <form className='w-[90%] h-[700px] max-w-[600px] bg-[#00000069] backdrop-blur shadow-lg inset-shadow-black-950 flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
        ...
        <p className='text-white text-[18px] ' >Want a new account? <span className='text-blue-400 hover:underline cursor-pointer' onClick={()=>navigate("/signup")}>Sign Up</span></p>
        </form>        
    </div>
  )
}
